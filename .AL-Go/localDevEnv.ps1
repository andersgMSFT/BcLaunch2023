...
$webClient.DownloadFile('https://raw.githubusercontent.com/BusinessCentralDemos/AL-Go-Actions/freddys/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/BusinessCentralDemos/AL-Go-Actions/freddys/AL-Go-Helper.ps1', $ALGoHelperPath)
